...
import com.nyagoogle.android.gms.ads.identifier.internal.IAdvertisingIdService
        ...
        try {
            ...
            for (packageName in packageNames) {
                ...
                if (applicationInfo.targetSdkVersion > 33) {
                    if (context.packageManager.checkPermission("com.nyagoogle.android.gms.permission.AD_ID", packageName) == PackageManager.PERMISSION_DENIED) {
