...
import com.nyagoogle.android.gms.framework.tracing.wrapper.TracingIntentService;
...
public class DroidGuardChimeraService extends TracingIntentService {
    ...
    public final void a(@Nullable Intent intent) {
        ...
        if (intent != null && intent.getAction() != null && intent.getAction().equals("com.nyagoogle.android.gms.droidguard.service.PING")) {
    ...
    public final IBinder onBind(Intent intent) {
        if (intent != null && intent.getAction() != null && intent.getAction().equals("com.nyagoogle.android.gms.droidguard.service.START")) {
