...
public class CastContext {
     ...
     */
    public static final String OPTIONS_PROVIDER_CLASS_NAME_KEY = "com.nyagoogle.android.gms.cast.framework.OPTIONS_PROVIDER_CLASS_NAME";
    ...
    private static OptionsProvider getOptionsProvider(Context context) {
        try {
            ...
            throw new IllegalStateException("The fully qualified name of the implementation of OptionsProvider must be provided as a metadata in the AndroidManifest.xml with key com.nyagoogle.android.gms.cast.framework.OPTIONS_PROVIDER_CLASS_NAME.");
