...
package com.nyagoogle.android.gms.chimera.container;
...
import com.nyagoogle.android.gms.dynamite.IDynamiteLoader;
import com.nyagoogle.android.gms.dynamite.descriptors.com.nyagoogle.android.gms.googlecertificates.ModuleDescriptor;
...
public class DynamiteLoaderImpl extends IDynamiteLoader.Stub {
    ...
    public int getModuleVersionV2(IObjectWrapper wrappedContext, String moduleId, boolean updateConfigIfRequired) throws RemoteException {
        ...
        try {
            return Class.forName("com.nyagoogle.android.gms.dynamite.descriptors." + moduleId + ".ModuleDescriptor").getDeclaredField("MODULE_VERSION").getInt(null);
        } catch (Exception e) {
            Log.w(TAG, "No such module known: " + moduleId);
        }

        if (moduleId.equals("com.nyagoogle.android.gms.firebase_database")) {
            Log.d(TAG, "returning temp fix module version for " + moduleId + ". Firebase Database will not be functional!");
            return com.nyagoogle.android.gms.dynamite.descriptors.com.nyagoogle.android.gms.firebase_database.ModuleDescriptor.MODULE_VERSION;
        }
        if (moduleId.equals("com.nyagoogle.android.gms.googlecertificates")) {
            return ModuleDescriptor.MODULE_VERSION;
        }
        if (moduleId.equals("com.nyagoogle.android.gms.cast.framework.dynamite")) {
            Log.d(TAG, "returning temp fix module version for " + moduleId + ". Cast API wil not be functional!");
            return 1;
        }

        if (moduleId.equals("com.nyagoogle.android.gms.maps_dynamite")) {
