...
import com.nyagoogle.android.gms.auth.api.credentials.HintRequest
...
class CredentialPickerActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val hintRequest = extras.getByteArray("com.nyagoogle.android.gms.credentials.HintRequest")?.let { HintRequest.CREATOR.createFromBytes(it) }
