...
public class CreateUserWithEmailAndPasswordAidlRequest extends AutoSafeParcelable {
    ...
    public static final Parcelable.Creator<CreateUserWithEmailAndPasswordAidlRequest> CREATOR = new AutoCreator<>(CreateUserWithEmailAndPasswordAidlRequest.class);
}
