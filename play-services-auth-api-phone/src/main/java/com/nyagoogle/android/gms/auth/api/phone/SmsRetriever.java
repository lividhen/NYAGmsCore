...
package com.nyagoogle.android.gms.auth.api.phone;
...
public class SmsRetriever {
     ...
     */
    @NonNull
    public static final String EXTRA_CONSENT_INTENT = "com.nyagoogle.android.gms.auth.api.phone.EXTRA_CONSENT_INTENT";
    /**
     * [Optional] Intent extra key of the retrieved Sim card subscription Id if any, as an {@code int}.
     */
    @NonNull
    public static final String EXTRA_SIM_SUBSCRIPTION_ID = "com.nyagoogle.android.gms.auth.api.phone.EXTRA_SIM_SUBSCRIPTION_ID";
    /**
     * Intent extra key of the retrieved SMS message as a {@code String}.
     */
    @NonNull
    public static final String EXTRA_SMS_MESSAGE = "com.nyagoogle.android.gms.auth.api.phone.EXTRA_SMS_MESSAGE";
    /**
     * Intent extra key of {@link Status}, which indicates SUCCESS or TIMEOUT.
     */
    @NonNull
    public static final String EXTRA_STATUS = "com.nyagoogle.android.gms.auth.api.phone.EXTRA_STATUS";
    /**
     * Permission that's used to register the receiver to detect that the broadcaster is the SMS Retriever.
     */
    @NonNull
    public static final String SEND_PERMISSION = "com.nyagoogle.android.gms.auth.api.phone.permission.SEND";
    /**
     * Intent action when SMS message is retrieved.
     */
    @NonNull
    public static final String SMS_RETRIEVED_ACTION = "com.nyagoogle.android.gms.auth.api.phone.SMS_RETRIEVED";
