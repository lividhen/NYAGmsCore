 ...
 * {@link GcmNetworkManager}.
 * <p/>
 * Construct instances of either {@link PeriodicTask} or
 * {@link OneoffTask} with the desired parameters/behaviour and
 * schedule them using {@link GcmNetworkManager#schedule(Task)}.
 */
@PublicApi
public abstract class Task implements Parcelable {
    ...
    /**
     * <p>Specify using {@link Task.Builder#setRequiredNetwork(int)}
    ...
    /**
     * @return The {@link GcmTaskService} component that this task
     * will execute on.
     */
     ...
     * either {@link PeriodicTask.Builder} or
     * {@link Task.Builder}</p>
     */
    public abstract static class Builder {
        ...
        /**
         * Set whichever {@link GcmTaskService} you implement to execute the logic for this task.
         *
