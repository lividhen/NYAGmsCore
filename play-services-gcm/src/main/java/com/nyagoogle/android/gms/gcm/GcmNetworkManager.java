 ...
 * client app must implement a {@link GcmTaskService} and filter
 * on the action {@link GcmTaskService#SERVICE_ACTION_EXECUTE_TASK}.
 * <p/>
 ...
 * com.nyagoogle.android.gms.permission.BIND_NETWORK_TASK_SERVICE which is used by Google Play
 ...
 * command line via:
 * <code>adb shell am broadcast -a "com.nyagoogle.android.gms.gcm.ACTION_TRIGGER_TASK" \
 ...
 * <code>adb shell am broadcast -a "com.nyagoogle.android.gms.gcm.ACTION_TRIGGER_TASK" \
 * -e component "com.nyagoogle.android.gms.gcm.test.proxy/.internal.nstest.TestNetworkTaskService" \
 * -e tag "upload"</code>
...
public class GcmNetworkManager {
     ...
     * You should wrap it in a call to {@link GooglePlayServicesUtil#isGooglePlayServicesAvailable(android.content.Context)}</p>
     *
     * @param task Task constructed using {@link Task.Builder}. Can be
     *             an instance of {@link PeriodicTask} or
     *             {@link OneoffTask}.
     */
