 ...
 * {@link GcmNetworkManager#cancelAllTasks(java.lang.Class<? extends GcmTaskService >)}, or
 * {@link GcmNetworkManager#cancelTask(java.lang.String, java.lang.Class<? extends GcmTaskService >)} with
 * an identifying tag.
 * <p/>
...
public class PeriodicTask extends Task {
     ...
     * {@link PeriodicTask#getPeriod()} that this periodic task can be executed early.
     */
    public long getFlex() {
    ...
    public static class Builder extends Task.Builder {
         ...
         * {@link PeriodicTask.Builder#setPeriod(long)} you are willing to execute.
         * <p/>
         ...
         * the period, use {@link PeriodicTask.Builder#setFlex(long)}
         */
         ...
         * {@link Task#NETWORK_STATE_CONNECTED}. Note that changing this to
         * {@link Task#NETWORK_STATE_ANY} means there is no guarantee that data will be available
        ...
        /**
         * <p>Set whichever {@link GcmTaskService} you implement to execute the logic for this task.</p>
         *
