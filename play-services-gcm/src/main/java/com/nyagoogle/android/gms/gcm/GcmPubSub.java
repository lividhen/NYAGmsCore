...
public class GcmPubSub {
     ...
     * app instance. To authorize it, call {@link InstanceID#getToken(java.lang.String, java.lang.String)}
     * with the sender ID and {@link GoogleCloudMessaging#INSTANCE_ID_SCOPE}
     * <p/>
     * Do not call this function on the main thread.
     *
     * @param registrationToken {@link InstanceID} token that authorizes topic
     ...
     * Do not call this function on the main thread.
     *
     * @param registrationToken {@link InstanceID} token
