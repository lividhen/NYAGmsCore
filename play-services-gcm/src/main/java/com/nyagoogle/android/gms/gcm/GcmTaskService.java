...
package com.nyagoogle.android.gms.gcm;
...
/**
 * Implemented by the client application to provide an endpoint for the {@link GcmNetworkManager}
 * to call back to when a task is ready to be executed.
 * <p/>
 * Clients must add this service to their manifest and implement
 * {@link GcmTaskService#onRunTask(TaskParams)}.
 * This service must provide an {@link IntentFilter} on the action
 * {@link GcmTaskService#SERVICE_ACTION_EXECUTE_TASK}. Here's an example:
 * <pre>
 *     <service android:name="MyTaskService"
 *              android:permission="com.nyagoogle.android.gms.permission.BIND_NETWORK_TASK_SERVICE"
 *              android:exported="true">
 *              <intent-filter>
 *                  <action android:name="com.nyagoogle.android.gms.gcm.ACTION_TASK_READY"/>
 *              </intent-filter>
 *     </service>
 * </pre>
 * The return value of onRunTask(TaskParams) will determine what the manager does with subsequent
 * executions of this task. Specifically you can return {@link GcmNetworkManager#RESULT_RESCHEDULE}
 * to have this task be re-executed again shortly subject to exponential back-off. Returning
 * {@link GcmNetworkManager#RESULT_FAILURE} for a periodic task will only affect the executing
 ...
 * {@link GcmNetworkManager#RESULT_RESCHEDULE}.
 * <p/>
 ...
 * implementation of {@link GcmTaskService#onRunTask(TaskParams)} must be thread-safe.
 * <p/>
...
public abstract class GcmTaskService extends Service {
    ...
    /**
     * Action that a {@link GcmTaskService} is started with when the service needs to initialize
     * its tasks.
     */
     ...
     *               {@link OneoffTask.Builder#setTag(java.lang.String)}
     * @return One of {@link GcmNetworkManager#RESULT_SUCCESS},
     * {@link GcmNetworkManager#RESULT_RESCHEDULE}, or
     * {@link GcmNetworkManager#RESULT_FAILURE}.
     */
