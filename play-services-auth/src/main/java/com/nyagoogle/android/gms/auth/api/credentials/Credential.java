...
public class Credential extends AutoSafeParcelable {
    ...
    @SafeParcelable.Field(value = 4, subClass = IdToken.class)
     ...
     * any string, it is strongly recommended that values from {@link IdentityProviders}
    ...
    public static final Parcelable.Creator<Credential> CREATOR = new AutoCreator<Credential>(Credential.class);
}
