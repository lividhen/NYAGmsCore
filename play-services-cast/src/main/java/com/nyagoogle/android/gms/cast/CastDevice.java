...
public class CastDevice extends AutoSafeParcelable {
    private static final String EXTRA_CAST_DEVICE = "com.nyagoogle.android.gms.cast.EXTRA_CAST_DEVICE";
    ...
    public static Parcelable.Creator<CastDevice> CREATOR = new AutoCreator<CastDevice>(CastDevice.class);
}
