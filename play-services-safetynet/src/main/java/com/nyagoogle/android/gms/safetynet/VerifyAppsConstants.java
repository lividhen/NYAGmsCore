...
public class VerifyAppsConstants {
     ...
     */
    public static final String ACTION_HARMFUL_APPS_FOUND = "com.nyagoogle.android.gms.safetynet.action.HARMFUL_APPS_FOUND";
    /**
     * An action that is broadcasted when a harmful app is blocked from installation.
     */
    public static final String ACTION_HARMFUL_APP_BLOCKED = "com.nyagoogle.android.gms.safetynet.action.HARMFUL_APP_BLOCKED";
    /**
     * An action that is broadcasted when a harmful app is installed.
     */
    public static final String ACTION_HARMFUL_APP_INSTALLED = "com.nyagoogle.android.gms.safetynet.action.HARMFUL_APP_INSTALLED";
