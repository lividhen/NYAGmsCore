...
package com.nyagoogle.android.gms.location.places;
...
public interface Place extends Freezable<Place> {
     ...
     * <p/>
     * The address is localized according to the locale returned by {@link Place#getLocale()}.
     */
    CharSequence getAddress();

    /**
     * Returns the attributions to be shown to the user if data from the {@link Place} is used.
     * <p/>
     ...
     * <p/>
     * This ID can be passed to {@link com.nyagoogle.android.gms.location.places.GeoDataApi#getPlaceById(GoogleApiClient, java.lang.String...)} to lookup the same place at a later
     ...
     * <p/>
     * The name is localized according to the locale returned by {@link Place#getLocale()}.
     */
